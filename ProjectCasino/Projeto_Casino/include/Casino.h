...
class Casino
{
    ...
    public:
        ...
        list<Jogador *> *Jogadores_Mais_Frequentes(); // Função que vai definir o jogador que teve mais interações com as máquinas do casino no dado dia
        ...
        void VerificarEstadoMaquina(const string& nomeMaquina);
        void MenuPrincipal();
        void Escolheramalta();
